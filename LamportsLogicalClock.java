...
public class LamportsLogicalClock {
    ...
    public static int[][] getLamportsTimestamp(){
        ...
        for(Integer value:values){
            ...
            if(key%10-1>0){
                ...
                if(key%10+1<noOfEvents[key/10])
                    clock[key/10][key%10+1]=Integer.max(clock[key/10][key%10+1],clock[key/10][key%10]+1);
            }else{
        ...
        for(int i=0;i<noOfProcesses;i++){
            for(int j=0;j<noOfEvents[i]-1;j++){
                if(clock[i][j+1]<clock[i][j]){
                    clock[i][j+1]=clock[i][j]+1;
                }
            }
        }
        return clock;
    ...
    public static void main(String[] args) {
        /*
            ...
            Test case 3:-
            No. of processes: 4
            No. of events per process: 6 2 4 3
            No. of relationships: 5
            Relationships: 20>00 02>31 03>21 10>04 22>30
        */
